...
(1, 1, 1, 'order_issue', 'Wrong item delivered', 'I ordered veg momo but received spring rolls', 'high', 'open'),
(1, 2, 2, 'quality_complaint', 'Food was cold', 'Butter chicken was served cold and not fresh', 'medium', 'open'),
